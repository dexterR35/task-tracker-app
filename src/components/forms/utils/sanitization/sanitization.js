...
import { FIELD_TYPES, getFieldSanitizeType } from '../../configs/fieldTypes';
...
// Sanitize individual field value based on field type using handlers
export const sanitizeFieldValue = (value, fieldConfig) => {
  ...
  // Get sanitization type from handlers
  const sanitizeType = getFieldSanitizeType(type);
  let sanitizedValue = value;

  // Apply type-specific sanitization using handlers
  switch (sanitizeType) {
    case 'text':
