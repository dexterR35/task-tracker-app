    ...
    sections: [
      {
        ...
        items: [
          ...
          { text: "Month Board Creation", description: "Only users with 'create_boards' permission (typically admins) can create month boards. Tasks can only be created for months with an active board. If board is missing, a banner automatically appears allowing admins to create it with one click. Board validation occurs before task creation" },
          { text: "Deliverable Calculation in Table", description: "Formula: (time per unit in minutes × quantity) + (variations quantity × variations time in minutes). Time conversion: if unit is 'hr', multiply by 60 to get minutes. Final time is converted to hours (divide by 60) and days (divide by 480, where 480 minutes = 8 hours = 1 day). Table shows: quantity × deliverable name, how it's calculated showing (time per unit × quantity + variations), and total time in hours and days. Example: 2x Logo with 1h per unit = (60min × 2) + 0 = 120min = 2h (0.25 days). Variations add extra time per variation if deliverable requires quantity" },
