          ...
          <div className="space-y-6 text-gray-700 dark:text-gray-300">
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
              ...
              <p className="text-sm leading-relaxed mb-4">
                ...
                and metrics are computed per month. This allows for month-to-month comparison to track progress, identify trends, and analyze 
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
              ...
              <p className="text-sm leading-relaxed mb-4">
                ...
                filters → finally apply global search. This ensures consistent filtering across all tables. Filters persist 
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
              ...
              <p className="text-sm leading-relaxed mb-4">
                <strong>Data tables</strong> display calculated metrics in structured format. Table data is generated by grouping tasks 
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
              ...
              <p className="text-sm leading-relaxed mb-4">
                SYNC uses <strong>Recharts</strong> for displaying data visualizations. Charts show task data in different formats: 
              ...
              <p className="text-sm leading-relaxed mb-4">
                <strong>Color system</strong>: Colors are assigned based on category names using hash-based mapping 
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
              ...
              <p className="text-sm leading-relaxed">
                ...
                This prevents rounding errors and ensures accurate time tracking across deliverables and tasks.
              </p>
                </div>
            ...
            <div className="border-b border-gray-200 dark:border-gray-700 pb-6 mb-6">
              ...
              <p className="text-sm leading-relaxed mb-4">
                ...
                while large cards display detailed metrics with charts and tables.
              </p>
              <p className="text-sm leading-relaxed mb-4">
                ...
                supports different modes (main, daily) that determine which cards are shown.
              </p>
              <p className="text-sm leading-relaxed mb-4">
