      ...
      <div className=" mx-auto">
        ...
        <div className="text-center mb-12">
          ...
          <div className="mt-8">
            ...
            {/* Core Framework */}
            <div className="mb-4">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Core Framework</h3>
            ...
            {/* Backend & Database */}
            <div className="mb-4">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Backend & Database</h3>
              <div className="flex flex-wrap justify-center gap-3 max-w-5xl mx-auto">
            ...
            {/* UI & Styling */}
            <div className="mb-4">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">UI & Styling</h3>
              <div className="flex flex-wrap justify-center gap-3 max-w-5xl mx-auto">
                <span className="px-4 py-2 bg-cyan-100 dark:bg-cyan-900/30 text-cyan-800 dark:text-cyan-300 rounded-lg text-sm font-medium">
                  TailwindCSS 4.1.11
                </span>
                <span className="px-4 py-2 bg-red-100 dark:bg-red-900/30 text-red-800 dark:text-red-300 rounded-lg text-sm font-medium">
                  Framer Motion 12.23.12
                </span>
                <span className="px-4 py-2 bg-teal-100 dark:bg-teal-900/30 text-teal-800 dark:text-teal-300 rounded-lg text-sm font-medium">
                  React Icons 5.5.0
                </span>
                <span className="px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-800 dark:text-gray-300 rounded-lg text-sm font-medium">
            ...
            {/* Forms & Validation */}
            <div className="mb-4">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Forms & Validation</h3>
              <div className="flex flex-wrap justify-center gap-3 max-w-5xl mx-auto">
                ...
                <span className="px-4 py-2 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 rounded-lg text-sm font-medium">
                  Yup 1.7.0
                </span>
                <span className="px-4 py-2 bg-yellow-100 dark:bg-yellow-900/30 text-yellow-800 dark:text-yellow-300 rounded-lg text-sm font-medium">
            ...
            {/* Data & Tables */}
            <div className="mb-4">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Data & Tables</h3>
              <div className="flex flex-wrap justify-center gap-3 max-w-5xl mx-auto">
                <span className="px-4 py-2 bg-pink-100 dark:bg-pink-900/30 text-pink-800 dark:text-pink-300 rounded-lg text-sm font-medium">
            ...
            <div className="mb-4">
              <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-300 mb-2">Notifications & Utilities</h3>
              <div className="flex flex-wrap justify-center gap-3 max-w-5xl mx-auto">
                <span className="px-4 py-2 bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300 rounded-lg text-sm font-medium">
