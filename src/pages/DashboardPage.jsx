    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-lg shadow-md p-4 mb-6 flex flex-col md:flex-row flex-wrap gap-4 items-end">
          ...
          {/* Apply button removed; filtering happens instantly without global spinner */}
        </div>
...
// (Inline TaskCharts removed; now lazy-loaded component in components/TaskCharts.jsx)
