...
/** POST /api/task-boards – get or create board. Body: { year, month, monthName?, status? } */
export async function getOrCreate(req, res, next) {
  try {
    ...
    const result = await query(
      `INSERT INTO task_boards (department_id, year, month, month_name, created_by, status, start_date, end_date)
